...
<html lang="en" suppressHydrationWarning>
  <head>
    ...
    <title>MonoDoc - Convert Github Repositories to Markdown for AI</title>
    <meta name="description" content="MonoDoc is a free utility to flatten multi-file GitHub repositories into a single, AI-ready Markdown document. Copy your entire codebase for ChatGPT or Claude instantly." />
    <meta name="keywords" content="github to markdown, repo to txt, code to ai, chatgpt codebase prompt, claude repo upload" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://monodoc.smabid.me/" />
    <meta property="og:title" content="MonoDoc - Convert Repos to AI Prompts" />
    <meta property="og:description" content="Flatten entire multi-file repositories into a single Markdown document for AI context." />
  </head>
  <body>
    <div id="root"></div>
...
{
  "name": "MonoDoc",
  "description": "Convert web pages and repositories to Markdown",
...
```json
{
  ...
  "private": false,
  "version": "2.2.1",
  "description": "Flatten entire multi-file repositories into a single, AI-ready Markdown document.",
  "type": "module",
  "bin": {
    "monodoc-pack": "cli.js"
  },
  ...
  "scripts": {
    "dev": "tsx server.ts",
    "build": "vite build && esbuild server.ts --bundle --platform=node --outdir=dist/server --format=cjs",
...
```txt
User-agent: *Allow: /Sitemap: https://monodoc.smabid.me/sitemap.xml
```

### public/sitemap.xml

```xml
<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">   <url>      <loc>https://monodoc.smabid.me/</loc>      <lastmod>2024-05-13</lastmod>      <changefreq>monthly</changefreq>      <priority>1.0</priority>   </url></urlset>
```
...
export default function App() {
  ...
  const [outputFormat, setOutputFormat] = useState<'markdown' | 'xml'>('markdown'); 
  const stats = useMemo(() => {
    let totalSize = 0;
    let totalTokens = 0;
    ...
    for (const file of selectedFiles) {
      ...
      totalTokens += encoder.encode(file.content).length; 
    }
    return {
